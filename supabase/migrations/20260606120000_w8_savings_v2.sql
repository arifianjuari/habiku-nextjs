-- W8 — Tabungan v2: bunga, kunci deposito, klaim target → tabung/cair
-- (Enum di migrasi 20260606115000_w8_savings_v2_enums.sql)
...
-- transfer_goal_hp: definisi lengkap ada di 20260624120000_goal_hp_transfer.sql

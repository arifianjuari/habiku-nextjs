...
alter table public.savings_pockets
  add constraint savings_pockets_monthly_interest_bps_check
  check (monthly_interest_bps >= 0);

alter table public.family_settings
  drop constraint if exists family_settings_max_monthly_interest_bps_check;

alter table public.family_settings
  add constraint family_settings_max_monthly_interest_bps_check
  check (max_monthly_interest_bps >= 0);

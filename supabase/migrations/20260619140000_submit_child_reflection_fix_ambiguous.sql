-- Perbaikan: «column reference reflection_date is ambiguous» — nama kolom RETURNS TABLE
-- bentrok dengan referensi kolom di INSERT / RETURN QUERY dalam PL/pgSQL.
-- Idempotent: create or replace sama seperti 20260619120000 (setelah perbaikan).

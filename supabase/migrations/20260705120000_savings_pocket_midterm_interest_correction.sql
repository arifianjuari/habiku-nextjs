-- Ortu boleh koreksi bunga/koefisien saat kantong sudah berisi saldo.
-- Berlaku prospektif: akrual bulan berikutnya memakai rate baru; bunga yang sudah diposting tidak diubah.
-- Tipe kantong dan durasi kunci tetap dikunci selama saldo > 0.
